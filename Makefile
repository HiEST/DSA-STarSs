...
SRC=user_mmap.c main_interface.c
#OBJ=$(SRC:.c=.o)
...
$(TESTCASES): main_interface.o user_mmap.o
	$(CC) $(CFLAGS) $(OMPSS_FLAGS) $(AVAIV_64_FUNC) $(EXTRA) -o $(TESTCASES) main_interface.o user_mmap.o -L$(OFED_DIR)/lib -libverbs -lrdmacm
	#$(CC) $(CFLAGS) -o $(TESTCASES) -L$(OFED_DIR)/lib -libverbs -lrdmacm

main_interface.o: main_interface.c user_mmap.h
...
clean:
	rm -f user_mmap.o main_interface.o $(TESTCASES)
